...
import io.github.wafarm.moretweaks.Moretweaks;
...
public enum FeatureToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean> {
    ...
    public String getComment() {
        ...
        if (this.singlePlayer) {
            return this.comment + "\n" + StringUtils.translate("moretweaks.label.config_comment.single_player_only");
        }
        else {
            return this.comment;
        }
    ...
    public void setValueFromJsonElement(JsonElement element) {
        try
        {
            ...
            {
                Moretweaks.logger.warn("Failed to set config value for '{}' from the JSON element '{}'", this.getName(), element);
            }
        }
        catch (Exception e)
        {
            Moretweaks.logger.warn("Failed to set config value for '{}' from the JSON element '{}'", this.getName(), element, e);
        }
    }
}
